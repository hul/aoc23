console.log("Advent of Code 2023 - star 1");
...
function sumCalibrationValues(input) {
  ...
  return lines.filter(Boolean).reduce((acc, curr, index) => {
    const numbers = curr.match(/\d/g).filter(Boolean);
...
console.log(`Test Input Result: ${sumCalibrationValues(testInput)}`);
console.log(`Test Input Result: ${sumCalibrationValues(input)}`);
